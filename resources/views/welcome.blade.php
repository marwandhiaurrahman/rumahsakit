...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <a href="index.html" class="logo m-2"><img src="{{asset('assets/img/logo rs waled ico.png')}}" alt="" class="img-fluid"></a>
      <h1 class="logo me-auto"><a href="index.html">RS Waled</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      <h1>SIM RS Waled</h1>
      <h2>Sistem Informasi Management Rumah Sakit Waled</h2>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            <h3>Dokter & Perawat Tenaga Ahli Pilihan Terbaik</h3>
