        ...
        <div class="col-md-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    {{-- <br> --}}
                    {!! Form::model($perawatan->reseps->first(), ['method' => 'PATCH', 'route' => ['admin.apotek.update', $perawatan->id], 'files' => true]) !!}
                    <div class="form-group">
                        <label for="iStatus">Status Resep Obat</label>
                        {!! Form::select('status', $status, null, ['class' => 'form-control', 'placeholder'=>'Pilih Status Resep Obat','id' => 'iStatus']) !!}
                    </div>
