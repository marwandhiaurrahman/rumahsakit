        ...
        <div class="col-12">
            <div class="row">
                    ...
                    <div class="small-box bg-danger">
                        ...
                        @can('admin-role')
                            <a href="#" class="small-box-footer" data-toggle="modal" data-target="#createModal">
                                Daftarkan Pasien Sakit <i class="fas fa-info-circle"></i>
                            </a>
                        @endcan
                    </div>
                </div>
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-success">
                        ...
                        @can('admin-role')
                            <a href="#" class="small-box-footer" data-toggle="modal" data-target="#createModal">
                                Daftarkan Pasien Baru <i class="fas fa-info-circle"></i>
                            </a>
                        @endcan
                    </div>
                </div>
            ...
            <div class="card card-secondary">
                <div class="card-header">
                    <h3 class="card-title">Tabel Data Pasien Terdaftar</h3>
                </div>
                <div class="card-body">
                                        ...
                                        @foreach ($pasiens as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    href="{{ route('admin.rekam-medis.show', $item->id) }}"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title" id="createModalLabel">Daftar Pasien Baru</h5>
