    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Analisis Dokter</h3>
                </div>
                <div class="card-body">
                    {!! Form::model($perawatan, ['method' => 'PATCH', 'route' => ['admin.rawat-jalan.update', $perawatan->id], 'files' => true]) !!}
                    ...
                    <div class="custom-control custom-checkbox">
                        ...
                        <label for="iCek" class="custom-control-label">Dengan ini menyatakan data telah
                            sesuai</label>
                    </div>
